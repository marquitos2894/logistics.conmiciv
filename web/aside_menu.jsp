<%-- 
    Document   : aside_menu
    Created on : 07/08/2017, 12:44:03 AM
    Author     : Marco
--%>
...
<div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="active">
                    <a href="#"><i class="fa fa-table"></i> <span class="nav-label">Inventario</span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li><a href="table_basic.html">Static Tables</a></li>
                        <li class="active"><a href="table_data_tables.html">Data Tables</a></li>
                        <li class="active"><a href="componentes.jsp">Almacen</a></li>
